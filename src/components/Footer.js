        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">eGotickets</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/organiser" className="text-gray-400 hover:text-white transition-colors">
                  Organiser Guide
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-400">
              © 2025 eGotickets. All rights reserved.
            </div>
            <div className="flex items-center space-x-6 text-sm">
              ...
              <div className="flex space-x-2">
                ...
                <span className="bg-gray-800 px-3 py-1 rounded text-xs">WhatsApp</span>
                <span className="bg-gray-800 px-3 py-1 rounded text-xs">Mobile App</span>
              </div>
            </div>
          </div>
        </div>
